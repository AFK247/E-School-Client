  ...
  return (
    <div className="sticky top-0 z-50">
      <div className="navbar bg-black ">
        <div className="navbar-start ">
          <div className="dropdown">
            <label
              ...
              tabIndex={0}
              className="btn mt-4 ml-3 btn-ghost text-yellow-300 block sm:hidden"
            >
              {!action && (
                <AdjustmentsHorizontalIcon className="mt-2 h-6 w-6 text-yellow-300" />
              )}
        ...
        <div className="navbar-center hidden sm:block text-white">
          <a href="#about" className="btn btn-ghost normal-case text-xl">
            Home
          </a>
          <a href="#about" className="btn btn-ghost normal-case text-xl">
